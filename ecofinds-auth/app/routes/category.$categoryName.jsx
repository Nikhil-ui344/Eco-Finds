...
import { categories, getProductsByCategoryName } from '../data/mockData';
import styles from './CategoryPage.module.css';

export function meta() {
  return [
    { title: "Category | EcoFinds" },
...
export default function CategoryPage() {
  ...
  const categoryProducts = useMemo(() => {
    ...
    let filtered = getProductsByCategoryName(category.name);
      ...
      <section className={styles.ctaSection}>
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            ...
            <Link to="/sell" className={styles.ctaButton}>Start Selling Today</Link>
          </div>
        </div>
      </section>
    </div>
